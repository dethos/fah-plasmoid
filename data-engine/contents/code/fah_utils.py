...
def parse_simulation_response(data):
    ...
    # The Output generated by F@H Client uses PyOn Notation. Given the absense
    # of a module in the standard library and the compatible output that
    # is generated in this context, JSON library is used
