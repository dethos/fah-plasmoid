...
def simulation_info(id):
    ...
    try:
        ...
        return {"error": "Unable to connect to local FAH client"}

    connection.read_until(delimiter, 1)
    connection.write(command)
    wu_data = connection.read_until(delimiter, 1)
    connection.close()
...
def parse_simulation_response(data):
    ...
    try:
        ...
        # The Output generated by F@H Client uses PyOn Notation. Given the
        # absense of a module in the standard library and the compatible
        # output that is generated in this context, JSON library is used
